...
public class User {
	...
	public User(String userId, String username, String email, String phoneNo, String address, String dateOfBirth,
			String physicalDisability, String identityProof, String loginId, String password, int age) {
		super();
		this.userId = userId;
